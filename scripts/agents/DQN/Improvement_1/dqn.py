...
class DQNAgent:
    ...
    def __init__(self, env):
        ...
        self.metrics = Metrics(365 * 24 * 60 // 5, "Improvement 1 DQN Agent")
    ...
    def save(self, filename="scripts/agents/DQN/Improvement_1/improvement_1_dqn_agent"):
        # Save the trained model
        self.model.save(filename)

    def load(self, filename="scripts/agents/DQN/Improvement_1/improvement_1_dqn_agent"):

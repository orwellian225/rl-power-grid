...
data_improvement_2 = pd.read_csv("logs/improvement_2_dqn_evaluation_results.csv")
...
average_improvement_2 = data_improvement_2[data_improvement_2['Run'] == 'Average']

# Create a DataFrame with the values for plotting
plot_data = pd.DataFrame({
    'Implementation': ['Baseline', 'Baseline', 'Improvement 1', 'Improvement 1', 'Improvement 2', 'Improvement 2'],
    'Metric': ['Steps', 'Total Reward', 'Steps', 'Total Reward', 'Steps', 'Total Reward'],
    'Value': [
        ...
        average_improvement_2['Steps'].values[0], 
        average_improvement_2['Total Reward'].values[0]
    ]
})

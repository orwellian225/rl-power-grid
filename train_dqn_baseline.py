from scripts.agents.DQN.Baseline.dqn import DQNAgent
from stable_baselines3.common.callbacks import BaseCallback
from scripts.agents.DQN.Baseline.dqn_env import Gym2OpEnv
import csv
import numpy as np
...
class SimpleMetricsCallback(BaseCallback):
    def __init__(self, log_dir, verbose=0):
        ...
        # Create metrics file
        self.metrics_file = open(f"{self.log_dir}/baseline_dqn_metrics.csv", mode='w', newline='')
